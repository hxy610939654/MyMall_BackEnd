...
public class ShippingServiceImpl implements IShippingService {
    ...
    public ServerResponse<String> del(Integer userId,Integer shippingId){
        ...
        if(resultCount > 0){
            return ServerResponse.createBySuccess("Address delete succeed");
        }
    ...
    public ServerResponse update(Integer userId, Shipping shipping){
        ...
        if(rowCount > 0){
            return ServerResponse.createBySuccess("Address update succeed");
        }
    ...
    public ServerResponse<Shipping> select(Integer userId, Integer shippingId){
        ...
        if(shipping == null){
            return ServerResponse.createByErrorMessage("Can not find shipping address");
        }
        return ServerResponse.createBySuccess("Shipping address found",shipping);
    }
